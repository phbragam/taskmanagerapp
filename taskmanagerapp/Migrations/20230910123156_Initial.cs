    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "userteste@teste.com", "userteste", "123userteste" });

            migrationBuilder.InsertData(
                table: "Tarefas",
                columns: new[] { "Id", "Descricao", "Estado", "Titulo", "UsuarioId" },
                values: new object[] { 1, "Essa é uma tarefa de teste", 0, "Tarefa teste", 1 });
